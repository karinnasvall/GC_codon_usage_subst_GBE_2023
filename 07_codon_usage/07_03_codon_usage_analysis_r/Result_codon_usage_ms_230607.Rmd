...
The reson for perfoming codon usage analysis is to investigate if codon usage bias is present and if any bias could have an effect on the composition of the coding sequences and if this could influence the estimate of selection and evolutionary rate. 
